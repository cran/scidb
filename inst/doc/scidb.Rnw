...
SciDB schema:  <Expt:int32 NULL DEFAULT null,Run:int32 NULL DEFAULT null,
...
[1] "redimension(
       subarray(
         redimension(
           between(
             transpose(test),3,null,3,null),
           <val:double NULL>[j=3:3,4,0,i=0:4,5,0]),
          null,null,null,null),
       <val:double NULL>[i=0:4,5,0])"
\end{Soutput}
\begin{Sinput}
> B@schema
\end{Sinput}
